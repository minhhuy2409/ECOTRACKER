...
DEFAULT_DAILY_MISSIONS = [
    ...
    },
    {
        ...
        "description": "Sort plastic, paper, and glass into separate bins.",
        "category": "recycling",
        "bonus_points": 10,
    },
    {
        "title": "Recycle paper or cardboard",
        "description": "Recycle old newspapers, notebooks, or delivery boxes.",
        "category": "recycling",
        "bonus_points": 10,
    },
    {
        "title": "Recycle plastic bottles",
        "description": "Recycle plastic drink bottles or containers.",
        "category": "recycling",
        "bonus_points": 10,
    },
    {
        "title": "Recycle aluminum cans",
        "description": "Recycle soda cans or other metal containers.",
        "category": "recycling",
        "bonus_points": 10,
    },
    {
        "title": "Walk to your destination",
        "description": "Walk instead of taking a motorized vehicle today.",
        "category": "green_transport",
        "bonus_points": 15,
    },
    {
        "title": "Ride a bicycle",
        "description": "Ride your bike to work, school, or for errands.",
        "category": "green_transport",
        "bonus_points": 20,
    },
    {
        "title": "Use public transit",
        "description": "Take the bus, train, or subway today.",
        "category": "green_transport",
        "bonus_points": 15,
    },
    {
        "title": "Carpool with others",
        "description": "Share a ride with friends, family, or colleagues.",
        "category": "green_transport",
        "bonus_points": 15,
    },
    {
    ...
    },
    {
        ...
        "description": "Keep lights off in unoccupied rooms.",
        "category": "saving_energy",
        "bonus_points": 10,
    },
    {
        "title": "Use natural light",
        "description": "Open curtains to use daylight instead of electric lights.",
        "category": "saving_energy",
        "bonus_points": 10,
    },
    {
        "title": "Use a reusable bag",
        "description": "Bring your own shopping bag to the store.",
        "category": "reusable_item",
        "bonus_points": 10,
    },
    {
        "title": "Use a reusable bottle",
        "description": "Drink from a reusable water bottle today.",
        "category": "reusable_item",
        "bonus_points": 10,
    },
    {
        "title": "Clean up a public street",
        "description": "Pick up plastic waste or litter on your street.",
        "category": "clean_up",
        "bonus_points": 15,
    },
]
...
DEFAULT_WEEKLY_MISSIONS = [
    ...
    {
        "title": "Weekly Waste Sorter",
        "description": "Sort plastic, paper, and organic waste 5 times.",
        "category": "recycling",
        "bonus_points": 50,
        "required_count": 5,
    },
    {
        "title": "Can and Bottle Recycler",
        "description": "Recycle metal cans or plastic bottles 7 times.",
        "category": "recycling",
        "bonus_points": 60,
        "required_count": 7,
    },
    {
        "title": "Weekly Pedestrian Walk",
        "description": "Walk to your daily destinations 5 times this week.",
        "category": "green_transport",
        "bonus_points": 50,
        "required_count": 5,
    },
    {
        ...
        "description": "Commute by riding a bicycle 5 times.",
        "category": "green_transport",
        "bonus_points": 65,
        "required_count": 5,
    },
    {
        "title": "Public Transit Supporter",
        "description": "Use public transit (bus or train) 5 times.",
        "category": "green_transport",
        "bonus_points": 55,
        "required_count": 5,
    },
    {
        "title": "Weekly Standby Energy Saver",
        "description": "Unplug standby electronics 7 times.",
        "category": "saving_energy",
        "bonus_points": 50,
        "required_count": 7,
    },
    {
        "title": "Reusable Bag Advocate",
        "description": "Use reusable grocery bags 5 times this week.",
        "category": "reusable_item",
        "bonus_points": 45,
        "required_count": 5,
    },
    {
        "title": "Hydration Eco Warrior",
        "description": "Drink from a reusable water bottle 7 times.",
        "category": "reusable_item",
        "bonus_points": 50,
        "required_count": 7,
    },
    {
        "title": "Park Caretaker volunteer",
        "description": "Pick up trash at local parks 3 times.",
        "category": "clean_up",
        "bonus_points": 50,
        "required_count": 3,
    },
